...
public class TachHoKhauController {
    ...
    public void setData() {
        DefaultTableModel hokhau_model = this.tableModelHoKhau.setTableHoKhau(listHoKhau, COLUNMS);
        ...
        TableRowSorter<DefaultTableModel> sorter2 = new TableRowSorter<>(hokhau_model);
