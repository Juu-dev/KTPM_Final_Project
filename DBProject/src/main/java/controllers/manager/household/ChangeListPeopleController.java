...
public class ChangeListPeopleController {
    ...
    private final NhanKhau nhanKhauService = new NhanKhau();
    ...
    public void setData() {
        ...
        TableRowSorter<DefaultTableModel> sorter = new TableRowSorter<>(model_people);
        table_people.setRowSorter(sorter);
        
       // Định dạng header
        table_people.getTableHeader().setDefaultRenderer(new utility.HeaderRenderer());
        table_people.getTableHeader().setPreferredSize(new Dimension(100, 50));

        // Màu sắc hàng chẵn/lẻ
        table_people.setDefaultRenderer(Object.class, new CustomTableCellRenderer());
...
//                JOptionPane.showConfirmDialog(null, table.getSelectedRow());
        ...
        TableRowSorter<DefaultTableModel> sorter2 = new TableRowSorter<>(model_mem);
        table_mem.setRowSorter(sorter2);
        
       // Định dạng header
        table_mem.getTableHeader().setDefaultRenderer(new utility.HeaderRenderer());
        table_mem.getTableHeader().setPreferredSize(new Dimension(100, 50));
